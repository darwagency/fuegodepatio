  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 pointer-events-none flex items-center gap-3">
      ...
      <a
        ...
        className="hidden sm:flex pointer-events-auto items-center justify-center w-12 h-12 rounded-full bg-brand-beige text-brand-dark border border-brand-dark/15 shadow-lg hover:-translate-y-1 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-brand-orange/40"
      >
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      >
        ...
        <span className="text-sm font-bold">Hablar por WhatsApp</span>
      </a>
    </div>
  );
}
